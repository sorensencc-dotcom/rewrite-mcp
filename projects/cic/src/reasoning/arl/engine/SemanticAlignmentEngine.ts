...
export function computeSemanticAlignment(packet: ReasoningPacket): SemanticAlignment {
...
function extractRecognizedEntities(semanticMap: Record<string, any>): string[] {
...
function extractUnrecognizedEntities(semanticMap: Record<string, any>): string[] {
...
function scoreRelationshipMatches(semanticMap: Record<string, any>): number {
