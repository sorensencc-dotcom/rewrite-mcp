...
export function computeTemporalConsistency(packet: ReasoningPacket): TemporalConsistency {
...
function scoreTemporalOrdering(recentExpansions: any[]): number {
...
function scoreCausality(recentExpansions: any[]): number {
...
function detectTemporalConflicts(recentExpansions: any[]): number {
...
function measureDriftTemporalImpact(driftScore: number): number {
