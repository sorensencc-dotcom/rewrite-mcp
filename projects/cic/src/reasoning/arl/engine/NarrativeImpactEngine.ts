...
export function computeNarrativeImpact(packet: ReasoningPacket): NarrativeImpact {
...
function scoreNarrativeReinforcement(narrativeSpine: string, recentExpansions: any[]): number {
...
function scoreNarrativeDilution(narrativeSpine: string, recentExpansions: any[]): number {
...
function scoreNarrativeContradiction(narrativeSpine: string, recentExpansions: any[]): number {
...
function scoreNarrativeNovelty(recentExpansions: any[]): number {
...
function scoreNarrativeRisk(narrativeSpine: string, recentExpansions: any[]): number {
