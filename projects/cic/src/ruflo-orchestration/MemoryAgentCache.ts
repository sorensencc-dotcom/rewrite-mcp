...
import { IAgentCache, CacheEntry, ICacheStats } from "./IAgentCache";

export class MemoryAgentCache implements IAgentCache {
  ...
  constructor(capacity: number = 1000, defaultTtlMs: number = 3600000) {
    this.cache = new Map();
