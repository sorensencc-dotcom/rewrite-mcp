 ...
 */
router.get("/api/feedback-loop/status", (req: Request, res: Response) => {
 ...
 */
router.post("/api/feedback-loop/run-now", async (req: Request, res: Response) => {
  const scheduler = getScheduler();
 ...
 * Start the scheduler
 */
router.post("/api/feedback-loop/start", (req: Request, res: Response) => {
  const scheduler = getScheduler();
 ...
 * Stop the scheduler
 */
router.post("/api/feedback-loop/stop", (req: Request, res: Response) => {
  const scheduler = getScheduler();
