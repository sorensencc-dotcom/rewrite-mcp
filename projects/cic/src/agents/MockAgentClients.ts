 ...
 */
export class CodeAnalyzerAgent implements AgentClient {
  async invoke(
    method: string,
 ...
 */
export class CallGraphExtractorAgent implements AgentClient {
  async invoke(
    method: string,
    input: Record<string, unknown>,
    traceId: string
 ...
 */
export class NarrativeLinkerAgent implements AgentClient {
  async invoke(
    method: string,
    input: Record<string, unknown>,
    traceId: string
 ...
 */
export class ContextSynthesizerAgent implements AgentClient {
  async invoke(
    method: string,
    input: Record<string, unknown>,
    traceId: string
 ...
 * Idea Parser Mock
 */
export class IdeaParserAgent implements AgentClient {
  async invoke(
    method: string,
    input: Record<string, unknown>,
    traceId: string
 ...
 */
export class IdeaClassifierAgent implements AgentClient {
  async invoke(
    method: string,
    input: Record<string, unknown>,
    traceId: string
 ...
 */
export class RefactorProposalEngine implements AgentClient {
  async invoke(
    method: string,
    input: Record<string, unknown>,
    traceId: string
 ...
 * Test Generator Mock
 */
export class TestGeneratorAgent implements AgentClient {
  async invoke(
    method: string,
    input: Record<string, unknown>,
    traceId: string
 ...
 */
export function createMockAgents(): Record<string, AgentClient> {
  return {
