...
export declare function computeDriftImpact(semantic: SemanticAlignment, temporal: TemporalConsistency, narrative: NarrativeImpact, causal: CausalReasoning, composite: CompositeReasoning): DriftImpact;
