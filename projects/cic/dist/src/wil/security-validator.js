...
export class SecurityValidator {
     ...
     */
    static validateShellCommand(command) {
        const violations = [];
    ...
    static validateFilePath(filePath) {
        ...
        const toUnix = (p) => p.replace(/\\/g, '/').replace(/^[A-Za-z]:/, '');
    ...
    static getSecurityReport() {
        return {
            ...
            config: this.validateConfig(process.env),
            workspace: {
    ...
    static containsCredentialPattern(text) {
        const patterns = [
    ...
    static checkConfigRecursive(obj, path, violations) {
