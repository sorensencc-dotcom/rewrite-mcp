 ...
 */
export class RealCodeAnalyzerAgent {
 ...
 */
export class RealCallGraphExtractorAgent {
    async invoke(method, input, traceId) {
 ...
 */
export class RealNarrativeLinkerAgent {
    async invoke(method, input, traceId) {
 ...
 */
export class RealContextSynthesizerAgent {
    async invoke(method, input, traceId) {
 ...
 */
export class RealIdeaParserAgent {
    async invoke(method, input, traceId) {
 ...
 */
export class RealIdeaClassifierAgent {
    async invoke(method, input, traceId) {
 ...
 */
export class RealRefactorProposalEngine {
    async invoke(method, input, traceId) {
 ...
 */
export class RealTestGeneratorAgent {
    async invoke(method, input, traceId) {
 ...
 */
export function createRealAgents() {
    return {
