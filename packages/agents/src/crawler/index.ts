...
const DEFAULT_POLITENESS_MS = 2_000;
...
export class CrawlerEngine {
  ...
  private async fetchWithRetry(url: string, capturedAt: string): Promise<CrawlResult> {
    let lastResult: CrawlResult | undefined;
