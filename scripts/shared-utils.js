 ...
 */
export function getStagedFiles(extensions = ['.ts'], excludePatterns = ['__tests__', '.spec.', '.test.']) {
  try {
 ...
 */
export function findServiceRoot(filePath) {
 ...
 */
export function findTsConfig(dir) {
  let current = dir;
  while (current !== '/') {
