...
const FlowRegistry_js_1 = require("../src/ruflo-orchestration/FlowRegistry.js");
const FlowOrchestrator_js_1 = require("../src/ruflo-orchestration/FlowOrchestrator.js");
const FlowLoader_js_1 = require("../src/ruflo-orchestration/FlowLoader.js");
// Simple mock agents for demonstration
const createMockAgents = () => {
    const logAgent = (name) => ({
        invoke: async (method, input, traceId) => {
...
async function runFirstFlow() {
    ...
    const registry = new FlowRegistry_js_1.FlowRegistry();
    const agents = createMockAgents();
    const orchestrator = new FlowOrchestrator_js_1.FlowOrchestrator({
        registry,
        agents,
        maxConcurrency: 5,
    ...
    const loaded = FlowLoader_js_1.FlowLoader.loadAndRegister(registry, flowsPath);
...
//# sourceMappingURL=test-first-flow.js.map