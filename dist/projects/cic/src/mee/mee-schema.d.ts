...
export interface RefactorInsight {
    id: string;
    file: string;
    type: "complexity" | "duplication" | "dead_code" | "unused_import" | "long_function" | "large_module" | "drift" | "style" | "architecture";
    message: string;
...
export type MeeRunStatus = "pending" | "running" | "paused" | "completed" | "failed" | "canceled";
...
export type MeeAutonomousJobStatus = "pending" | "running" | "paused" | "completed" | "failed";
...
export type MeeAgentRole = "planner" | "refactor" | "tester" | "docs" | "safety" | "research";
...
export declare function isResearchFinding(obj: any): obj is ResearchFinding;
export declare function isMeePhaseSpec(obj: any): obj is MeePhaseSpec;
export declare function isMeeMetaRule(obj: any): obj is MeeMetaRule;
export declare function isRefactorInsight(obj: any): obj is RefactorInsight;
//# sourceMappingURL=mee-schema.d.ts.map