...
exports.MCPError = exports.MCPClient = exports.MCP_SERVERS = void 0;
...
function getPortForMethod(method) {
    if (method.startsWith("cic.summarize"))
        return exports.MCP_SERVERS.summarizer.port;
    if (method.startsWith("cic.detectDrift"))
        return exports.MCP_SERVERS.drift.port;
    if (method.startsWith("cic.diagnose"))
        return exports.MCP_SERVERS.diagnostics.port;
    if (method.startsWith("cic.syncDocs"))
        return exports.MCP_SERVERS.docs.port;
    if (method.startsWith("orchestrate"))
        return exports.MCP_SERVERS.orchestrator.port;
    throw new Error(`Unknown MCP method: ${method}`);
}
function getTimeoutForMethod(method) {
    if (method.startsWith("cic.summarize"))
        return exports.MCP_SERVERS.summarizer.timeout;
    if (method.startsWith("cic.detectDrift"))
        return exports.MCP_SERVERS.drift.timeout;
    if (method.startsWith("cic.diagnose"))
        return exports.MCP_SERVERS.diagnostics.timeout;
    if (method.startsWith("cic.syncDocs"))
        return exports.MCP_SERVERS.docs.timeout;
    if (method.startsWith("orchestrate"))
        return exports.MCP_SERVERS.orchestrator.timeout;
    return 5000;
}
// ============================================================================
// MCP Client
...
class MCPClient {
    ...
    async call(method, params, context) {
        const correlationId = context?.correlationId || (0, node_crypto_1.randomUUID)();
