...
exports.ArpsMemoryPipeline = void 0;
...
const memory_harvester_js_1 = require("../../memory/memory-harvester.js");
class ArpsMemoryPipeline {
    constructor(repoRoot, docsRoot, registryPath) {
        this.repoRoot = repoRoot;
        this.docsRoot = docsRoot;
        this.registryPath = registryPath;
        const ledgerPath = node_path_1.default.join(repoRoot, '.artifacts/memory/ledger.jsonl');
        this.substrate = new memory_substrate_js_1.MemorySubstrate(ledgerPath);
        this.memoryHarvester = new memory_harvester_js_1.MemoryHarvester(this.substrate, repoRoot);
    }
    /**
    ...
    async emitArpsDelta(delta) {
        try {
            ...
            let gitCommit = '';
            try {
                gitCommit = (0, node_child_process_1.execSync)('git rev-parse HEAD', {
                    cwd: this.repoRoot,
                    encoding: 'utf-8'
                }).trim();
            }
    ...
    async run(opts) {
        ...
        if (opts.commit && !opts.dryRun) {
            ...
            try {
                ...
                (0, node_child_process_1.execSync)(`git commit -m "[claude] chore(arps): apply roadmap delta ${cleanTimestamp}"`, { cwd: this.repoRoot });
                if (opts.verbose)
...
exports.ArpsMemoryPipeline = ArpsMemoryPipeline;
