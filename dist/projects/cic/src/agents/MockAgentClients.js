...
exports.TestGeneratorAgent = exports.RefactorProposalEngine = exports.IdeaClassifierAgent = exports.IdeaParserAgent = exports.ContextSynthesizerAgent = exports.NarrativeLinkerAgent = exports.CallGraphExtractorAgent = exports.CodeAnalyzerAgent = void 0;
exports.createMockAgents = createMockAgents;
/**
 * Code Analyzer Mock
...
exports.CodeAnalyzerAgent = CodeAnalyzerAgent;
/**
 * Call Graph Extractor Mock
 * Simulates call graph extraction
 */
class CallGraphExtractorAgent {
    async invoke(method, input, traceId) {
...
exports.CallGraphExtractorAgent = CallGraphExtractorAgent;
/**
 * Narrative Linker Mock
 * Simulates documentation linking
 */
class NarrativeLinkerAgent {
    async invoke(method, input, traceId) {
...
exports.NarrativeLinkerAgent = NarrativeLinkerAgent;
/**
...
exports.ContextSynthesizerAgent = ContextSynthesizerAgent;
/**
 * Idea Parser Mock
 */
...
exports.IdeaParserAgent = IdeaParserAgent;
/**
...
exports.IdeaClassifierAgent = IdeaClassifierAgent;
/**
...
exports.RefactorProposalEngine = RefactorProposalEngine;
/**
 * Test Generator Mock
 */
