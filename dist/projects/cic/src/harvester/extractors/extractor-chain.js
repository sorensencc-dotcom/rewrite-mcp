...
exports.ExtractorChain = void 0;
const multi_stage_js_1 = require("../../pms/v2/multi-stage.js");
const metrics_collector_js_1 = require("../../reasoning/metrics-collector.js");
const spec_registry_js_1 = require("../../cic/control-plane/spec-registry.js");
const telemetry_sink_js_1 = require("../../cic/control-plane/telemetry-sink.js");
class ExtractorChain {
    constructor() {
        this.chain = [];
        this.pms = {
            requestPrompt: async (stage, context) => {
                return multi_stage_js_1.multiStageOrchestrator.requestPrompt(stage, context);
            }
        };
    }
    add(extractor) {
    ...
    async run(rawText, metadata = {}) {
        ...
        const instincts = spec_registry_js_1.specRegistry.evaluateInstincts("documentary_ingest", docType, sourceFormat, tenantId, region);
        const activeInstincts = spec_registry_js_1.specRegistry.getInstincts().filter(i => i.trigger.pipeline === "documentary_ingest" &&
        ...
        for (const instinct of activeInstincts) {
            ...
            void (0, telemetry_sink_js_1.getTelemetrySink)().recordInstinct({
                runId,
        ...
        try {
            for (const extractor of this.chain) {
                ...
                try {
                    ...
                    const activeRules = spec_registry_js_1.specRegistry.getRules()
                        .filter(r => r.target.pipeline === "documentary_ingest" && r.target.stage === "evidence_pack")
                        .map(r => r.name);
                    const activeHooks = spec_registry_js_1.specRegistry.getHooks()
                    ...
                    void (0, telemetry_sink_js_1.getTelemetrySink)().recordSkill({
                        runId,
                        pipeline: "documentary_ingest",
                        stage: "evidence_pack",
            ...
            metrics_collector_js_1.metricsCollector.recordIngestion(chainDuration, latencies);
        }
        catch (err) {
            pipelineOutcome = "failure";
            metrics_collector_js_1.metricsCollector.recordIngestionError();
            void (0, telemetry_sink_js_1.getTelemetrySink)().enrichInstinct(runId, {
                pipelineOutcome,
                driftDelta: 0.1,
        ...
        await spec_registry_js_1.specRegistry.runHooks("before_pipeline_commit", {
...
exports.ExtractorChain = ExtractorChain;
