...
exports.AutonomousModeEngine = void 0;
class AutonomousModeEngine {
    ...
    makeAutonomousDecision(expansionScore, confidenceLevel, state) {
    ...
    autonomouslyReject(reason, severity, state) {
        const rejection = {
    ...
    autonomouslyEscalate(path, severity, state) {
        const escalation = {
    ...
    autonomouslyStabilize(action, state) {
        const stabilization = {
...
exports.AutonomousModeEngine = AutonomousModeEngine;
//# sourceMappingURL=AutonomousModeEngine.js.map